...
class Game:
    ...
    def __init__(self, window, screen, width, height):
        ...
        self.character_width, self.character_height = 125, 125
    ...
    def check_collisions(self, ferret):
        ...
        if item:
            if self.isJump == True and ferret.bottom < item.top:
                ferret.bottom = item.top
#             if self.isJump == True and ferret.bottom > item.top:
#                  ferret.bottom
#             if self.isJump == False and ferret.bottom > item.top:
#                 ferret.left = item.right
#             if self.isJump == False and ferret.bottom < item.top:
#                  ferret.bottom
    ...
    def main(self):
        ...
        v = 10
        airtime = 0
        ferret = pygame.Rect(0, 800, self.character_width, self.character_height) #makes image an object
        lvl0=[]
        ...
        while run_me:
            ...
            self.p1.draw(self.screen, (194, 178, 128))
